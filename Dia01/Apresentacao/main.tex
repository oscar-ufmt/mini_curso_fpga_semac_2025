...
\title[Minicurso FPGAs]{\huge   Introdução ao Projeto Digital Avançado com VHDL e FPGA} %note that the optional arg in '[]' are displayed in the left column throughout the complete presentation
% adapt accordingly
